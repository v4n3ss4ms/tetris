...
void jugar(){
    ...
    puntuacion=0;
    PUNTO laPieza;
     //INFO DE PIEZAS ABAJO
    laPieza.x=limR/2;
    laPieza.y=1;
    laPieza.tipo=aleatorio(1,3);
    c=KEY_DOWN;
    refresh();
    WINDOW *ventanaJugar;
...
int compruebaAbajo(int Matriz[ALTOTAB][ANCHOTAB],PUNTO miPieza){
    ...
    switch (miPieza.tipo)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            if (((Matriz[(miPieza).y+1][((miPieza).x+1)]==0))&&((Matriz[(miPieza).y+1][(miPieza).x]==0))&&((Matriz[(miPieza).y][(miPieza).x-1]==0))){
                muevo=1;
            }else{
                muevo=0;
            }
...
int compruebaIzq(int Matriz[ALTOTAB][ANCHOTAB],PUNTO miPieza){
    ...
    switch (miPieza.tipo)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            if (((Matriz[(miPieza).y][(miPieza).x-1]==0))&&((Matriz[((miPieza).y+1)][(miPieza).x-2]==0))){
                muevo=1;
            }else{
                muevo=0;
            }
